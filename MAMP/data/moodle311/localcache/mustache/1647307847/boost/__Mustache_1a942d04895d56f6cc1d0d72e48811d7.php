...
class __Mustache_1a942d04895d56f6cc1d0d72e48811d7 extends Mustache_Template
{
...
';
        $buffer .= $indent . 'window.addEventListener(\'mouseover\', initLandbot, { once: true });
';
        $buffer .= $indent . 'window.addEventListener(\'touchstart\', initLandbot, { once: true });
';
        $buffer .= $indent . 'var myLandbot;
';
        $buffer .= $indent . 'function initLandbot() {
';
        $buffer .= $indent . '  if (!myLandbot) {
';
        $buffer .= $indent . '    var s = document.createElement(\'script\');s.type = \'text/javascript\';s.async = true;
';
        $buffer .= $indent . '    s.addEventListener(\'load\', function() {
';
        $buffer .= $indent . '      myLandbot = new Landbot.Popup({
';
        $buffer .= $indent . '        configUrl: \'https://chats.landbot.io/v3/H-1183152-OR3FRRX1N44FMCOO/index.json\',
';
        $buffer .= $indent . '      });
';
        $buffer .= $indent . '    });
';
        $buffer .= $indent . '    s.src = \'https://cdn.landbot.io/landbot-3/landbot-3.0.0.js\';
';
        $buffer .= $indent . '    var x = document.getElementsByTagName(\'script\')[0];
';
        $buffer .= $indent . '    x.parentNode.insertBefore(s, x);
';
        $buffer .= $indent . '  }
';
        $buffer .= $indent . '}
